...
if(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_STM32C562RET6")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC  arch/cmsis/CMSIS/Core/Include generated/hal stm32c5xx_dfp/Include stm32c5xx_drivers/hal stm32c5xx_drivers/ll stm32c5xx_drivers/timebases user_modifiable/_debug_GCC_STM32C562RET6)
...
set_property(DIRECTORY APPEND PROPERTY ADDITIONAL_CLEAN_FILES "${CMAKE_SOURCE_DIR}/build/${CMAKE_BUILD_TYPE}/${CMAKE_PROJECT_NAME}.bin")
